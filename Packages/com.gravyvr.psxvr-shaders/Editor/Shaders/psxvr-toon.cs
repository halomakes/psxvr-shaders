...
public class PsxvrToonUi : ShaderGUI
{
    ...
    private static Dictionary<string, string> Tooltips = new()
    {
    ...
    private void DrawBanner()
    {
        ...
        EditorGUI.LabelField(BannerRect, "PSXVR Toon", MainStyle);
    ...
    private static GUIContent MakeLabel(MaterialProperty property)
    {
